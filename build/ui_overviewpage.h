...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QString::fromUtf8("0 GYC"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0 GYC"));
        ...
        labelImmature->setText(QString::fromUtf8("0 GYC"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "<html><head/><body><p>The displayed information may be out of date. Your wallet automatically synchronizes with the musangKingcoin network after a connection is established, but this process has not completed yet.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
