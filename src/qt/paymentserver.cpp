...
const QString BITCOIN_IPC_PREFIX("musangKingcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click musangKingcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start musangKingcoin: click-to-pay handler");
    else
...
{
    // clicking on musangKingcoin: URLs creates FileOpen events on the Mac:
