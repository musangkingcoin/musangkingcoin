...
// Copyright (c) 2013 The musangKingcoin developers
...
uint256 hashGenesisBlock("0x000003093265e86a9b10604fe49a9a0e6fd947b7809d77f25e3202aeb2fdbc03");
static const unsigned int timeGenesisBlock = 1477577390;
...
const string strMessageMagic = "musangKingcoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "musangKingcoin 2016-10-27.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x0ef2198e637237e5f92274985f7797c48cc2d5e56ec05e9c055b15c10bd645d6"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("musangKingcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("musangKingcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("musangKingcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("musangKingcoin-miner");
    ...
    try { loop {
        ...
        printf("Running musangKingcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("musangKingcoinMiner terminated\n");
        throw;
    }
}
